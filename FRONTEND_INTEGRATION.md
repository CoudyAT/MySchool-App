# 🚀 Guide d'intégration Frontend - MySchool API v2.1.0
...
- [Service Payments (Nouveau)](#service-payments-nouveau-v210-)
...
## 📚 Endpoints disponibles (49 endpoints)
...
**Légende**: ✨ = Nouveau endpoint | ⚡ = Optimisé avec index Firestore | 🆕 = v2.1.0 Payment API
...
- 📖 49 endpoints documentés (41 existants + 8 paiements)
